...
ti.targets.C28_float.rootDir ?= C:/ti/ccsv6/tools/compiler/c2000_15.12.3.LTS
ti.targets.packageBase ?= C:/ti/bios_6_45_01_29/packages/ti/targets/
...
.dlls,28FP .dlls: mutex.p28FP

-include package/cfg/mutex_p28FP.mak
-include package/cfg/mutex_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/mutex_p28FP.dep
endif
mutex.p28FP: package/cfg/mutex_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
mutex.p28FP package/cfg/mutex_p28FP.c: .libraries,28FP
endif

package/cfg/mutex_p28FP.c package/cfg/mutex_p28FP.h package/cfg/mutex_p28FP.xdl: override _PROG_NAME := mutex.x28FP
package/cfg/mutex_p28FP.c: package/cfg/mutex_p28FP.cfg
package/cfg/mutex_p28FP.xdc.inc: package/cfg/mutex_p28FP.xdl
package/cfg/mutex_p28FP.xdl package/cfg/mutex_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/mutex_p28FP.cfg
	-$(RM) package/cfg/mutex_p28FP.dep
	-$(RM) package/cfg/mutex_p28FP.c
	-$(RM) package/cfg/mutex_p28FP.xdc.inc

clean,28FP::
	-$(RM) mutex.p28FP
.executables,28FP .executables: mutex.x28FP

mutex.x28FP: |mutex.p28FP

-include package/cfg/mutex.x28FP.mak
mutex.x28FP: package/cfg/mutex_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/mutex_p28FP.o28FP   package/cfg/mutex_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
mutex.x28FP: export C_DIR=
mutex.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
mutex.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

mutex.test test,28FP test: mutex.x28FP.test

mutex.x28FP.test:: mutex.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 mutex.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.mutex.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,mutex.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
mutex_p28FP.o28FP,copy : package/cfg/mutex_p28FP.o28FP
mutex_p28FP.s28FP,copy : package/cfg/mutex_p28FP.s28FP
...
package/rel/xconfig_mutex/xconfig_mutex/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_mutex/xconfig_mutex/package/package.rel.xml: package/build.cfg
package/rel/xconfig_mutex/xconfig_mutex/package/package.rel.xml: package/package.xdc.inc
